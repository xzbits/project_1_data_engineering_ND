...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, "
                         "start_time TIMESTAMP NOT NULL, user_id int NOT NULL, level text, song_id text, "
...
song_table_create = ("CREATE TABLE IF NOT EXISTS songs (song_id text PRIMARY KEY, title text NOT NULL, "
                     "artist_id text, year int, duration float8 NOT NULL);")

artist_table_create = ("CREATE TABLE IF NOT EXISTS artists (artist_id text PRIMARY KEY, name text NOT NULL, "
                       "location text, latitude float8, longitude float8);")
